  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid md:grid-cols-2 gap-4">
        <div className="rounded-3xl glass-panel shadow-soft dark:shadow-soft-dark p-6 bg-brand-green/5 dark:bg-brand-green/10 border border-brand-green/15">
        ...
        <div className="rounded-3xl glass-panel shadow-soft dark:shadow-soft-dark p-6 bg-amber-50/60 dark:bg-amber-950/20 border border-amber-200/60 dark:border-amber-900/40">
    ...
    <div className="space-y-4">
      {complaints.map((c: any) => (
        ...
        >
          ...
          <p className="text-sm text-gray-600 dark:text-gray-300 bg-gray-50 dark:bg-white/5 rounded-2xl px-4 py-3 mb-4">
            {c.message}
          </p>
          {c.reply ? (
