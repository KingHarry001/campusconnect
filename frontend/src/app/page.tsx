        ...
        <div className="min-h-screen bg-white">
          ...
          <nav className="flex items-center justify-between px-8 md:px-16 py-8 max-w-7xl mx-auto">
            <div className="flex items-center gap-3">
              ...
              <div className="leading-tight">
                <p className="font-medium text-base">Campus Connect</p>
                <p className="text-xs text-gray-400">
                  OOU · Computer Engineering
                </p>
              </div>
            </div>
            <Link
          ...
          >
            ...
            <p className="relative text-white/55 text-lg max-w-lg mx-auto mb-12 leading-relaxed">
              Schedules, attendance, assignments and department news — one
              place, built for OOU Computer Engineering.
            </p>
          ...
          <section className="max-w-6xl mx-auto px-8 mb-40">
            <p className="text-sm uppercase tracking-widest text-gray-400 text-center mb-3">
              How it works
            </p>
              ...
              {roles.map(({ icon: Icon, num, role, desc, dark }) => (
                <motion.div
                  ...
                  className={`rounded-[28px] p-12 ${
                    dark ? "bg-[#0f2a06] text-white" : "bg-gray-50"
                  }`}
                >
                  <span
                    className={`text-base ${
                      dark ? "text-green-400" : "text-gray-400"
                    }`}
                  >
                    {num}
                  </span>
          ...
          <section className="max-w-6xl mx-auto px-8 mb-40">
            ...
            >
              {[
                ...
                {
                  thumb: "/demo-thumb-2.jpeg",
                  label: "Lecturer & admin tools",
                },
              ].map(({ thumb, label }) => (
                <motion.button
                  key={label}
                ...
                >
                  ...
                  <p className="absolute bottom-6 left-6 text-white text-base font-medium">
                    {label}
                  </p>
                </motion.button>
              ))}
          ...
          <section className="max-w-3xl mx-auto px-8 mb-40">
            ...
            >
              <p className="font-voice italic text-3xl leading-relaxed mb-8">
                &ldquo;I stopped missing deadlines the week I started using
                this.&rdquo;
              </p>
